    ...
    var Criteria = /** @class */ (function () {
        ...
        Criteria.defaults = {
            ...
            i18n: {
                ...
                data: 'Фильтр по',
                "delete": '&times',
                deleteTitle: 'Удалить правило фильтра',
                left: '<',
                ...
                title: {
                    0: 'Конструктор пользовательского поиска',
                    _: 'Конструктор пользовательского поиска (%d)'
                },
                value: 'Значение',
                valueJoiner: 'and'
            },
    ...
    var SearchBuilder = /** @class */ (function () {
        ...
        SearchBuilder.defaults = {
            ...
            i18n: {
                ...
                data: 'Выберите столбец',
                "Удалить": '&times',
                deleteTitle: 'Удалить правило фильтра',
                left: '<',
                leftTitle: 'Убрать критерий',
                logicAnd: 'И',
                logicOr: 'Или',
                right: '>',
                rightTitle: 'Добавить критерий',
                title: {
                    0: 'Конструктор пользовательского поиска',
                    _: 'Конструктор пользовательского поиска (%d)'
                },
